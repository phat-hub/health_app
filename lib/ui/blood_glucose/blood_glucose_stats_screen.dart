...
class BloodGlucoseStatsScreen extends StatefulWidget {
  const BloodGlucoseStatsScreen({super.key});

  @override
  State<BloodGlucoseStatsScreen> createState() =>
      _BloodGlucoseStatsScreenState();
}

class _BloodGlucoseStatsScreenState extends State<BloodGlucoseStatsScreen> {
                        ...
                        PieChartData(
                          sections: stats.entries
                              ...
                              .map((e) => PieChartSectionData(
                                    ...
                                    color: getGlucoseStatusColor(e.key),
                                    radius: 60,
